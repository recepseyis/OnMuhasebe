...
namespace DevExpress.Internal {
    ...
    public const int VersionId = 191;
    public const int VersionIdMinor = 19101;
    public const string VersionShort = "19.1";
#if NETFX_CORE
    ...
    public const string MarketingVersion = "v2019 vol 1";
    public const string VirtDirSuffix = "_v19_1";
