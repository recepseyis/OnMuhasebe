...
namespace YemekYemek.Entities.Mapping
{
    public class KullaniciMap : EntityTypeConfiguration<Kullanici>
    {
        public KullaniciMap()
        {
            ...
            this.Property(p => p.Adi).HasMaxLength(50);
            this.Property(p => p.Soyadi).HasMaxLength(50);
            this.Property(p => p.Gorevi).HasMaxLength(50);
            this.Property(p => p.Parola).HasMaxLength(50);
            this.Property(p => p.HatirlatmaSorusu).HasMaxLength(50);
            this.Property(p => p.Cevap).HasMaxLength(50);
